...
defined in [`csharp/PhoneNumbers/PhoneNumberOfflineGeocoder.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/PhoneNumberOfflineGeocoder.cs)
...
[`PhoneNumberToCarrierMapper.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/PhoneNumberToCarrierMapper.cs)
...
[`csharp/PhoneNumbers/Phonenumber.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/Phonenumber.cs)). The
...
`TryParseValid` (see
[`csharp/PhoneNumbers.Extensions/PhoneNumber.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers.Extensions/PhoneNumber.cs)).
...
- [`PhoneNumberType`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/PhoneNumberType.cs) — `FIXED_LINE`, `MOBILE`, `TOLL_FREE`, `UNKNOWN`, ...
- [`PhoneNumberFormat`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/PhoneNumberFormat.cs) — `E164`, `INTERNATIONAL`, `NATIONAL`, `RFC3966`
- [`NumberParseException.ErrorType`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/NumberParseException.cs) — `INVALID_COUNTRY_CODE`, `NOT_A_NUMBER`, ...
- `PhoneNumberUtil.MatchType`, `PhoneNumberUtil.ValidationResult`, `PhoneNumberUtil.Leniency` (all in [`PhoneNumberUtil.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/PhoneNumberUtil.cs))
- [`ShortNumberInfo.ShortNumberCost`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/ShortNumberInfo.cs)
- `PhoneNumber.Types.CountryCodeSource` (in [`Phonenumber.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/Phonenumber.cs))
...
**C# (this port):** [`csharp/PhoneNumbers/Phonenumber.cs`](https://github.com/twcclegg/libphonenumber-csharp/blob/main/csharp/PhoneNumbers/Phonenumber.cs)
