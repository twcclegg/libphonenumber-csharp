...
# check-target-frameworks.sh (files the target-framework issue) - they source this rather than
# each carrying its own copy of the logging, api and release-creation plumbing.
#
