...
#pragma warning restore 1591
        ...
        /// </summary>
        /// <param name="countryCallingCode">the country calling code for which region codes are needed</param>
        /// <returns>an unmodifiable list of the region codes that match the given country calling code</returns>
        public IReadOnlyList<string> GetRegionCodesForCountryCode(int countryCallingCode)
        {
            return countryCallingCodeToRegionCodeMap.TryGetValue(countryCallingCode, out var codes)
                ? codes
                : Array.Empty<string>();
        }
