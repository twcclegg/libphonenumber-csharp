...
namespace PhoneNumbers
{
    ...
    public class PhoneNumberOfflineGeocoder
    {
        ...
        private readonly PrefixFileReader _prefixFileReader;

        internal PhoneNumberOfflineGeocoder(string phonePrefixDataDirectory, Assembly asm = null)
        {
            _prefixFileReader = new PrefixFileReader(phonePrefixDataDirectory, asm);
        }
        ...
        {
            _prefixFileReader.GetDescriptionForNumber(
        ...
        public string GetDescriptionForValidNumber(PhoneNumber number, Locale languageCode)
        {
            ...
            if (mobileToken.Length > 0 && nationalNumber.StartsWith(mobileToken))
            {
                // In some countries, e.g. Argentina, mobile numbers have a mobile token before the
                // national destination code. Remove it before geocoding.
